...
var invoices_route_exports = {};
__export(invoices_route_exports, {
  invoicesRoutes: () => invoicesRoutes
});
module.exports = __toCommonJS(invoices_route_exports);
...
var invoiceIdSchema = import_zod3.z.object({
...
var billedItemSchema2 = import_zod4.z.object({
...
var consumptionHistorySchema2 = import_zod4.z.object({
...
var uploadFileSchema = import_zod4.z.array(
  import_zod4.z.object({
    ...
    amount_due: import_zod4.z.preprocess((val) => parseFloat(val), import_zod4.z.number()),
    billed_items: import_zod4.z.array(billedItemSchema2),
    consumption_history: import_zod4.z.array(consumptionHistorySchema2)
  })
);
