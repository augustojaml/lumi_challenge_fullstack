...
var billedItemSchema = import_zod4.z.object({
  item_name: import_zod4.z.string(),
  unit: import_zod4.z.string(),
  quantity: import_zod4.z.number(),
  unit_price: import_zod4.z.number(),
  amount: import_zod4.z.number(),
  unit_rate: import_zod4.z.number()
});
var consumptionHistorySchema = import_zod4.z.object({
  month_year: import_zod4.z.string(),
  consumption_kwh: import_zod4.z.number(),
  average_kwh_per_day: import_zod4.z.number(),
  days: import_zod4.z.number()
});
var createInvoiceSchema = import_zod4.z.object({
  file_name: import_zod4.z.string(),
  reference_month: import_zod4.z.string(),
  due_date: import_zod4.z.string().transform((date) => new Date(date)),
  installation_number: import_zod4.z.string(),
  amount_due: import_zod4.z.number(),
  billed_items: import_zod4.z.array(billedItemSchema),
  consumption_history: import_zod4.z.array(consumptionHistorySchema)
});
...
var invoiceIdSchema = import_zod5.z.object({
...
var billedItemSchema2 = import_zod6.z.object({
  item_name: import_zod6.z.string(),
  unit: import_zod6.z.string(),
  quantity: import_zod6.z.number(),
  unit_price: import_zod6.z.number(),
  amount: import_zod6.z.number(),
  unit_rate: import_zod6.z.number()
});
var consumptionHistorySchema2 = import_zod6.z.object({
  month_year: import_zod6.z.string(),
  consumption_kwh: import_zod6.z.number(),
  average_kwh_per_day: import_zod6.z.number(),
  days: import_zod6.z.number()
});
var uploadFileSchema = import_zod6.z.array(
  import_zod6.z.object({
    file_name: import_zod6.z.string(),
    client_number: import_zod6.z.string(),
    reference_month: import_zod6.z.string(),
    due_date: import_zod6.z.string().transform((date) => new Date(date)),
    installation_number: import_zod6.z.string(),
    amount_due: import_zod6.z.preprocess((val) => parseFloat(val), import_zod6.z.number()),
    billed_items: import_zod6.z.array(billedItemSchema2),
    consumption_history: import_zod6.z.array(consumptionHistorySchema2)
  })
);
