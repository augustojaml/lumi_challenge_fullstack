...
var create_invoce_schema_exports = {};
__export(create_invoce_schema_exports, {
  createInvoiceSchema: () => createInvoiceSchema
});
module.exports = __toCommonJS(create_invoce_schema_exports);
...
var createInvoiceSchema = import_zod.z.object({
  ...
  amount_due: import_zod.z.number(),
