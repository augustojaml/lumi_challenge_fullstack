...
var prisma_clients_repository_exports = {};
__export(prisma_clients_repository_exports, {
  PrismaClientsRepository: () => PrismaClientsRepository
});
module.exports = __toCommonJS(prisma_clients_repository_exports);
